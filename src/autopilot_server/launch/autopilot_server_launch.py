...
def launch_setup(context: LaunchContext) -> list:
    ...
    print(
        f"Using robot xmacro file: {context.launch_configurations['robot_xmacro_file']}"
    )
    print(
        f"AUTOPILOT_SERVER Using params file: {context.launch_configurations['params_file']}"
    )
...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory("autopilot_server")
